$.extend(KhanUtil, {
    ...
    cardinal: function(n) {
        var cardinalScales = ["", "tausend", "million", "milliarden", "billion", "quadrillion", "quintillion", "sextillion", "septillion", "octillion", "nonillion", "decillion", "undecillion", "duodecillion", "tredecillion", "quattuordecillion", "quindecillion", "sexdecillion", "septendecillion", "octodecillion", "novemdecillion", "vigintillion"];
        var cardinalUnits = ["null", "ein", "zwei", "drei", "vier", "fünf", "sechs", "sieben", "acht", "neun", "zehn", "elf", "zwölf", "dreizehn", "vierzehn", "fünfzehn", "sechzehn", "siebzehn", "achtzehn", "neunzehn"];
        var cardinalTens = ["", "", "zwanzig", "dreizig", "vierzig", "fünfzig", "sechzig", "siebzig", "achtzig", "neunzig"];
        ...
        var smallNumberWords = function(n) {
            ...
            if (hundredDigit) {
                str += cardinalUnits[hundredDigit] + " hundert";
            }
